...
// // const APIUrl2 = "https://jsonplaceholder.typicode.com/albums"
// // fetch(APIUrl2)
// //       .then(response => response.json())
// //       .then(json => console.log(json))
//       const APIUrl3 = "https://mindhub-xj03.onrender.com/api/amazing"
//       fetch(APIUrl3)
//             .then(response => response.json())
...
//       const cardContainer = document.getElementById("contenedordeproductos")
...
//     //   }
//     //   let elementscard = createCards(APIUrl3)
